...
<xsl:template match="result">
    <html>
        ...
        <body>
            ...
            <div id="page" style="margin-top: 15%">            
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/static/public/header/headerV2.css"/>
		<link rel="stylesheet" href="/static/public/themes/aod/style.css" media="screen" type="text/css"/>
		<link rel="favourites icon" href="/static/public/i/favicon.ico"/>
		<script type="text/javascript" src="/static/public/portalAOD_funcs.js"></script>
	...
	<body>
	<div id="header">
	<div id="header1" class="fixed-top">
    <div class="relatedHeader container-fluid">
        <!--<ul class="nav">
        ...
        <div class="row primary nav">
            <div class="col-4 col-sm-6 ">
                <img class="img-fluid imgob" id="imgGobAragon" src="/static/public/contenido-general/header/logoDGABlanco.png"/>
                <img id="imgGobFEDER" class="img-fluid imgob" src="/static/public/contenido-general/header/logoFEDER.png" />
            </div>
            <div class="col-8  col-sm-6">
                <a class="nav-link col-3" href="http://transparencia.aragon.es/" target="_blank">TRANSPARENCIA</a>
                <a class="nav-link col-6" href="http://aragonparticipa.aragon.es" target="_blank">PARTICIPACIÓN CIUDADANA</a>
                <a class="nav-link active col-3" href="/">OPEN DATA</a>
            </div>
        </div>
    </div>
    <div class="navbar navbar-toggleable-md navbar-light" id="nav">
        ...
        <a class="navbar-brand logo" href="/">
            <img class="navbar-brand d-inline-block align-top" id="logo" src="/static/public/header/images/AOD-Logo.png" alt=""/>
        </a>
        <div id="loginLink" class="nav-item menuLogin">
            <a class="nav-link aLogin" href="/login">
                <img id="login" class="aLogin" src="/static/public/header/images/Boton-Acceso-Usuarios-OFF.png" onmouseover="hoverButtonLogin()"
                    onmouseout="outButtonLogin()" alt="" border="0" />
            </a>
        </div>
        <div class="navbar-item menu" onclick="openNav()">
            <a class="nav-link aMenu">
                <img id="menu" class="aMenu" src="/static/public/header/images/Boton-Menu-Responsive-OFF.png" onmouseover="hoverButtonMenu()"
                    onmouseout="outButtonMenu()" border="0" alt="x" />
            </a>
        </div>
    </div>
</div>
    ...
    <div class="overlay-content">
            ...
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="card-block">
                        <ul id="datos">
                            <li>
                                <a href="/datos/catalogo" onclick="openNav()">Banco de datos</a>
                            </li>
                            <li>
                                <a href="/datos/temas" onclick="openNav()">Temas</a>
                            </li>
                            <li>
                                <a href="/datos/publicadores" onclick="openNav()">Publicadores</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="card-block">
                        <ul id="servicios">
                            <li>
                                <a href="">Datos enlazados</a>
                            </li>
                            <li>
                                <a href="/servicios/aragopedia">Aragopedia</a>
                            </li>
                            <li>
                                <a href="http://presupuesto.aragon.es/">Presupuestos</a>
                            </li>
                            <li>
                                <a href="/servicios/analytics">Open Analytics Data</a>
                            </li>
                            <li>
                                <a href="/servicios/open-social-data">Open Social Data</a>
                            </li>
                            <li>
                                <a href="/servicios/visualdata">Open Visual Data</a>
                            </li>
                            <li>
                                <a href="/servicios/cras">CRAs Aragón</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree">
                    <div class="card-block">
                        <ul id="info">
                            <li>
                                <a href="/informacion/open-data" onclick="openNav()">Información</a>
                            </li>
                            <li>
                                <a href="/informacion/conocimiento" onclick="openNav()">Conocimiento</a>
                            </li>
                            <li>
                                <a href="/informacion/aplicaciones" onclick="openNav()">Aplicaciones</a>
                            </li>
                            <li>
                                <a href="/informacion/eventos" onclick="openNav()">Eventos</a>
                            </li>
                            <li>
                                <a href="/informacion/colabora" onclick="openNav()">Colabora</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div id="collapseFour" class="collapse" role="tabpanel" aria-labelledby="headingFour">
                    <div class="card-block">
                        <ul id="tools">
                            <li>
                                <a href="/herramientas/campus" onclick="openNav()">AOD Campus</a>
                            </li>
                            <li>
                                <a href="/herramientas/desarrolladores" onclick="openNav()">Desarrolladores</a>
                            </li>
                            <li>
                                <a href="/herramientas/apis" onclick="openNav()">APIs</a>
                            </li>
                            <li>
                                <a href="/sparql" onclick="openNav()">SPARQL</a>
                            </li>
                            <li>
                                <a href="https://github.com/aragonopendata/Aragon-Open-Data-3" target="_blank" onclick="openNav()">GITHUB</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div>
            <form class="search" method="post" onsubmit="return buscaCkan()">
                <input autocomplete="off" id="buscador_header" class="textBox" placeholder="BUSCA DATOS ABIERTOS" type="search" onkeyup='autocompleteRequest()'/>
                <!--<button type="submit" class="submit"><i aria-hidden="true" class="fa fa-search"></i></button>-->
                <button type="submit" class="btnSearch" onclick="openNav()">
			...
			<footer id="mainFooter" class="site-footer">
				<article class="container-fluid">
					<div class="row">
						<div class="col-md-4 threeCol">
							...
							<div class="threeCol_child">
								<div><a class="linkTermsVisited" href="/terminos">TERMINOS DE USO</a></div>
								<div class="row">
									<div class="col-md-3 eur-logo">
										<div class="img-eur-logo"></div>
										<img src="/static/public/footer/images/flag-europe.png" style="padding-left: 5px;"/>
									</div>
									<div class="col-md-9">
								...
								<div class="row">
									<div class=" col-xs-12  cc-logo">
										<div class="imgn">
											<img src="/static/public/footer/images/cc.png" width="100px"/>
										</div>
									</div>
									<div class="col-xs-12 paddingleft20">
										<div class="txt-cc-logo">
											<span>
												Los contenidos del portal están sujetos a licencia creative commons reconocimiento 4.0 salvo que se indique lo
												contrario
											</span>
										</div>
									</div>
						...
						<div class="col-md-4 threeCol">
							...
							<ul>
								<li><a class="linkVisited" href="/datos/catalogo">BANCO DE DATOS</a></li>
								<li><a class="linkVisited" href="/servicios/aragopedia/">ARAGOPEDIA</a></li>
								<li><a class="linkVisited" href="/servicios/open-social-data">OPEN SOCIAL DATA</a></li>
								<li><a class="linkVisited" href="/informacion/colabora">COLABORA</a></li>
								<li><a class="linkVisited" href="/informacion/aplicaciones">APLICACIONES</a></li>
								<li><a class="linkVisited" href="/informacion/open-data">INFO OPEN DATA</a></li>
							</ul>
						</div>
						<div class="col-md-4 threeCol logos_div">
							...
							<div class="logos paddingleft45">
								<div class="row show-grid ">
									<div class="col-xs-4 col-md-3 logos"><a class="ckan" href="http://ckan.org/" target="_blank">
											<img src="/static/public/footer/images/cajaLogoCKAN.jpg"/>
										</a></div>
									<div class="col-xs-4 col-md-3 logos"><a class="mediawiki" href="http://www.mediawiki.org/" target="_blank">
											<img src="/static/public/footer/images/cajaLogoMediaWiki.jpg"/>
										</a></div>
									<div class="col-xs-4 col-md-3 logos"> <a class="virtuoso" href="http://virtuoso.openlinksw.com/" target="_blank">
											<img src="/static/public/footer/images/cajaLogoVirtuoso.jpg"/>
										</a></div>
									<div class="col-xs-4 col-md-3 logos">
										<a class="elda" href="http://epimorphics.github.io/elda/" target="_blank">
											<img src="/static/public/footer/images/cajaLogoElda.jpg"/>
										</a>
									</div>
									<div class="separator"></div>
									<div class="col-xs-4 col-md-3 logos margintop10"> <a class="swagger" href="http://swagger.io/" target="_blank">
											<img src="/static/public/footer/images/cajaLogoSwagger.jpg"/>
										</a></div>
									<div class="col-xs-4 col-md-3 logos margintop10"><a class="node" href="https://nodejs.org/es/" target="_blank">
											<img src="/static/public/footer/images/cajaLogoNodeJS.jpg"/>
										</a></div>
									<div class="col-xs-4 col-md-3 logos margintop10"><a class="angular" href="https://angular.io/" target="_blank">
											<img src="/static/public/footer/images/cajaLogoAngular.jpg"/>
										</a></div>
									<div class="col-xs-4 col-md-3 logos margintop10"><a class="angular" href="https://www.elastic.co/products/kibana/"
										 target="_blank">
											<img src="/static/public/footer/images/cajaLogoKibana.jpg"/>
										</a></div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-8">
							<div class="twoCol">
								<img class="marginleft21" src="/static/public/footer/images/logo-aragob-blanco.png" width="150px"/>
								<div class="gobText">
						...
						<div class="col-md-4">
							<div class="social-nw">
								<div class="socialNetworkIcon">
									<a class="facebook" href="https://www.facebook.com/observatorio.aragones">
										<i class="fa fa-facebook-official"></i>
									</a>
								</div>
								<div class="socialNetworkIcon">
									<a class="twitter" href="https://twitter.com/oasi">
										<i class="fa fa-twitter"></i>
									</a>
								</div>
								<div class="socialNetworkIcon">
									<a class="youtube" href="https://www.youtube.com/watch?v=8d409yteTJM&amp;list=PLQ3k0vA0UZvhBVOz_mCq-9Wyn3VCB6QCe">
										<i class="fa fa-youtube-play"></i>
									</a>
								</div>
								<div class="socialNetworkIcon">
									<a class="mail" href="mailto:opendata@aragon.es">
										<i class="fa fa-envelope-o"><span>AOD</span></i>
									</a>
								</div>
							</div>
						</div>
