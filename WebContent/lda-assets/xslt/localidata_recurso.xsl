...
<xsl:template match="result" mode="meta">
    <link rel="shortcut icon" href="{$_resourceRoot}images/localidata/favlogo.png" type="image/x-icon" /> 
...
<xsl:template match="result" mode="style">
	...
	<link rel="stylesheet" href="{$_resourceRoot}css/localidata/localidata.css" type="text/css" />
    <xsl:comment>
...
<xsl:template match="result" mode="header">
    ...
    <header>
		<a href="http://www.localidata.com" target="webLocalidata">
        <h1><br/></h1>
		</a>
    </header>
</xsl:template>
...
<xsl:template match="result" mode="footer">
    <footer>
        ...
        <p>
			<xsl:text><strong>LOCALIDATA OPEN DATA ARAGÓN BETA</strong></xsl:text><br/>
